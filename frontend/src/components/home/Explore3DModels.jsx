    ...
    <section className="py-16 px-4 max-w-7xl mx-auto w-full text-gray-900 bg-[#fafafa]">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10 pb-6 border-b border-gray-200">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-black hover:bg-gray-800 text-white font-bold text-xs transition-all shadow-md shrink-0 uppercase tracking-wider"
        >
      ...
      {loading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {Array.from({ length: 10 }).map((_, i) => (
            <div key={i} className="h-72 bg-gray-100 animate-pulse rounded-3xl border border-gray-200" />
          ))}
        </div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {displayProducts.map((product) => {
            ...
            return (
              <div
                ...
                className="group relative bg-white border border-gray-200 hover:border-gray-400 rounded-3xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-gray-200/50 cursor-pointer flex flex-col justify-between"
              >
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                    ...
                    <div className="flex items-center gap-1.5">
                      <button
                        ...
                        title="Add to Cart"
                        className="p-2 rounded-xl bg-black hover:bg-gray-800 text-white transition-colors shadow-sm"
                      >
